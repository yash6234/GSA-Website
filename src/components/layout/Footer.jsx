...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-[1335px] mx-auto w-full px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-xl font-bold mb-4">Gandhinagar Sports Academy</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              Empowering young athletes to achieve excellence through world-class training, 
              state-of-the-art facilities, and dedicated mentorship.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/admissions" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Admissions
                </Link>
              </li>
              <li>
