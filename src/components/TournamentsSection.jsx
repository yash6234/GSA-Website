                ...
                {instagramPosts.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-items-center">
                    {instagramPosts.map((p) => (
                      <div key={p.id} className="w-full max-w-[540px] rounded-xl border border-gray-200 bg-white">
                  ...
                  <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 text-sm text-gray-600">
                    No Instagram embeds found. Add Instagram post links in <span className="font-semibold">CONTENT.tournaments.socialPosts</span> (as <span className="font-semibold">permalink</span>) to show them here.
                  </div>
                )}
