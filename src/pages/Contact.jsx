              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+91XXXXXXXXXX" className="hover:text-blue-600 transition-colors">
                        +91 XXX XXX XXXX
                      </a>
                      <br />
                      <a href="tel:+91XXXXXXXXXX" className="hover:text-blue-600 transition-colors">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:info@gandhinagarsportsacademy.com" className="hover:text-blue-600 transition-colors">
                        info@gandhinagarsportsacademy.com
                      </a>
                      <br />
                      <a href="mailto:admissions@gandhinagarsportsacademy.com" className="hover:text-blue-600 transition-colors">
